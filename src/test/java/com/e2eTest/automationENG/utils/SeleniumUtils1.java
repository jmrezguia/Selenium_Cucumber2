 ...
 * again.
 */
public class SeleniumUtils1 extends BasePage1 {
	...
	private static final Logger LOGGER = (Logger) LogManager.getLogger(SeleniumUtils1.class.getName());

	/**
	 * Instanciation de common utils.
	 */
	public SeleniumUtils1() {
		super(driver);
		SeleniumUtils1.driver = Setup1.getDriver();
	}
	...
	public void clickOnElementUsingActions(By element) {
		...
		actions.moveToElement(Setup1.getDriver().findElement(element));
	...
	public WebElement findElement(By locator) {
		try {
			return Setup1.getDriver().findElement(locator);
	...
	public List<WebElement> findElements(By locator) {
		try {
			return Setup1.getDriver().findElements(locator);
		} catch (NoSuchElementException e) {
	...
	public void selectOptionWithText(String textToSelect, WebElement elementWeb, By locator) {
		try {
			...
			// Obtenir toutes les options du dropdown
	...
	public void doubleClick(WebElement elt) {
		Actions act = new Actions(Setup1.getDriver());
		WebElement ele = elt;
